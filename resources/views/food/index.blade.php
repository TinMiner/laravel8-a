...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
						...
						@endif
            <div class="card">
                <div class="card-header">Tutti i Cibi
								...
								<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td><img src="images/{{$food->image}}" width="100"></td>
												<td>{{$food->name}}</td>
												...
												<td>
															...
															<button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$food->id}}">
																Delete
															</button>
